...
export function CampaignCard({ name, status, sent, openRate, clickRate, bounceRate }: CampaignCardProps) {
  return (
    <Card padding="none" className="p-4 bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
      ...
      <p className="text-2xl font-bold text-blue-900 mb-3">{sent.toLocaleString()} <span className="text-sm font-normal text-slate-500">sent</span></p>
